...
const navItems = [
  ...
  { title: "Produtos", url: "/products", icon: Box, allowedRoles: ["admin", "gerente", "funcionario"] },
  { title: "Estoque", url: "/stock", icon: Package, allowedRoles: ["admin", "gerente", "funcionario"] },
